    ...
    signatureProvider(...args) {
        ...
        return (network, _tron) => {
                ...
                return signargs => {
                    ...
                    return new Promise((resolve, reject) => {
                        ...
                        socketService.sendApiRequest({
                            ...
                            payload
                        }).then(x => resolve(x.signatures[0])).catch(x => reject(x));
                    });
                };
            };
            ...
            const setAddress = () => {
                ...
                const address = id && id.accounts.find(x => x.blockchain === Blockchains.TRX) ? id.accounts.find(x => x.blockchain === Blockchains.TRX).address : null;
